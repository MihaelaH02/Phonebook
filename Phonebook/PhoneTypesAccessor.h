...
protected:
	...
	BEGIN_ACCESSOR_MAP(CPhoneTypesAccessor, GLOBAL_ACCESSORS_INFO_NUMBERS_OF_ACCESSORS)
		...
		COLUMN_ENTRY(ACCESSORS_COLUMNS_INFO_ORDINAL_COLUMN_ID, m_recPhoneTypes.lId)
		END_ACCESSOR()

		BEGIN_ACCESSOR(GLOBAL_ACCESSORS_INFO_ACCESSOR_FOR_DATA, true)
		COLUMN_ENTRY(ACCESSORS_COLUMNS_INFO_ORDINAL_COLUMN_UPDATE_COUNTED, m_recPhoneTypes.lUpdateCounter)
