...
protected:
	...
	BEGIN_ACCESSOR_MAP(CPhoneNumbersAccessor, GLOBAL_ACCESSORS_INFO_NUMBERS_OF_ACCESSORS)
		...
		COLUMN_ENTRY(ACCESSORS_COLUMNS_INFO_ORDINAL_COLUMN_ID, m_recPhoneNumber.lId)
		END_ACCESSOR()

		BEGIN_ACCESSOR(GLOBAL_ACCESSORS_INFO_ACCESSOR_FOR_DATA, true)
		COLUMN_ENTRY(ACCESSORS_COLUMNS_INFO_ORDINAL_COLUMN_UPDATE_COUNTED, m_recPhoneNumber.lUpdateCounter)
		...
		COLUMN_ENTRY(STRUCT_PHONE_NUMBERS_ORDER_COL_NUMBERS_ISO_CODES, m_recPhoneNumber.lIdPhoneISOCode)
		END_ACCESSOR()
	END_ACCESSOR_MAP()
};
